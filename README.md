...
I craft efficient workflows and wield powerful tools. When I'm not battling bugs, you'll find me penning
tech tales on [dev.to](https://dev.to/sujit-shrc) or fine-tuning my digital habitat.
...
spell_book=(
    ["os"] = "Arch Linux"        # It tries to keep things simple and minimalistic. Thinking about NixOS, though." 🐧
    ...
    ["file_manager"] = "yazi"    # Faster than I can say 'cd'. Because life's too short for slow file operations." 🚀
)
